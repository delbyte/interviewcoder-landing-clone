    ...
    <section className="relative py-30 px-4 bg-black overflow-hidden">
      ...
      <div className="proof-bg relative z-10 w-full mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold mb-4 text-white">Interview Coder working on real assessments</h2>
          <p className="text-2xl text-white/70">Watch Interview Coder in action taking down the latest online assessments and technical interviews.</p>
        </div>
        ...
        {/* Second Video Section - IBM */}
        <div className="flex flex-col lg:flex-row lg:flex-row-reverse gap-6 my-8 w-3/5 mx-auto relative z-20">
          ...
          <div className="w-full lg:w-96 lg:flex-shrink-0">
            ...
            <div className="lg:hidden relative">
              ...
              <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2 px-8">
                <div className="cursor-pointer flex-shrink-0 bg-white/10 rounded-2xl">
                  <div className="relative rounded-2xl">
                    <div className="flex gap-4 p-2 flex-col lg:flex-row">
                      <div className="relative flex-shrink-0 lg:w-20 lg:h-14 w-36 h-24 rounded-lg overflow-hidden border-2 border-white/10">
                        <Image
                          src="https://api.interviewcoder.co/storage/v1/object/sign/Videos/landing-page/thumb-Using%20Interview%20Coder%20to%20pass%20the%20IBM%20Software%20Engineer%20OA%20(2026).avif?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8zZWI0ZWNhYy1jNDBlLTQxM2YtYjNjZC00ODIzMzJhNzcxMWMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJWaWRlb3MvbGFuZGluZy1wYWdlL3RodW1iLVVzaW5nIEludGVydmlldyBDb2RlciB0byBwYXNzIHRoZSBJQk0gU29mdHdhcmUgRW5naW5lZXIgT0EgKDIwMjYpLmF2aWYiLCJpYXQiOjE3NTgyODI1MjEsImV4cCI6MTc4OTgxODUyMX0.QGdfkNf6plu3y1gTt1vCHEvQDHdaJLCfp_BwAn0dGmU"
                      ...
                      <div className="lg:flex-1 lg:min-w-0 w-32">
                        <h4 className="text-white font-medium text-sm line-clamp-2 mb-1">Pass the IBM Software Engineer OA (2026)</h4>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="cursor-pointer flex-shrink-0">
                  <div className="relative rounded-2xl">
                    <div className="flex gap-4 p-2 flex-col lg:flex-row">
                      ...
                      <div className="lg:flex-1 lg:min-w-0 w-32">
                        <h4 className="text-white/70 font-medium text-sm line-clamp-2 mb-1">Pass the Citadel Software Engineer OA (2026)</h4>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="cursor-pointer flex-shrink-0">
                  <div className="relative rounded-2xl">
                    <div className="flex gap-4 p-2 flex-col lg:flex-row">
                      ...
                      <div className="lg:flex-1 lg:min-w-0 w-32">
                        <h4 className="text-white/70 font-medium text-sm line-clamp-2 mb-1">Pass the CapitalOne Software Engineer OA (2026)</h4>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="cursor-pointer flex-shrink-0">
                  <div className="relative rounded-2xl">
                    <div className="flex gap-4 p-2 flex-col lg:flex-row">
                      ...
                      <div className="lg:flex-1 lg:min-w-0 w-32">
                        <h4 className="text-white/70 font-medium text-sm line-clamp-2 mb-1">Pass the Roblox Software Engineer OA (2026)</h4>
                      </div>
                    </div>
                  </div>
                </div>
